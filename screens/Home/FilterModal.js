...
import {View, Image,Text,Animated,ScrollView,TouchableWithoutFeedback, Modal,TouchableOpacity} from 'react-native';
import { COLORS,FONTS, SIZES,constants,icons } from "../../constants";
import {TwoPointSilder,TextButton,TextIconButton} from "../../components";
import { Colors } from "react-native/Libraries/NewAppScreen";
import { color } from "react-native-reanimated";
const Section =({ containerStyle , title, children})=>{
    return(
        <View style={{marginTop:SIZES.padding,...containerStyle}}>
            <Text style={FONTS.h3,title}>
                {title}
            </Text>
            {children}
        </View>
                   ...
                   marginTop:SIZES.radius
                       ...
                       {constants.delivery_time.map((item,index)=>{
                           return(
                               ...
                               label={item.label}
                               labelStyle={{color:item.id == deliveryTime
