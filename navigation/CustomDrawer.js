...
const CustomDrawerItem =({label,icon, isFocused,onPress,navigation})=>{
    return(
        ...
        onPress={onPress}
        >
            <Image source={icon} style={{ width:20, height:29, tintColor:COLORS.white}} />
...
CustomDrawerContent =({navigation,setSelectedTab,selectedTab}) => {
    return (
         ...
         >
             ...
             > 
               ...
               <View style={{flex:1, marginTop:SIZES.padding}}>
                   ...
                   <CustomDrawerItem label ="Inivte a Friend" icon={icons.profile}/>
